...
public class Interpreter {
    public static void main(String[] args){
        ...
        ProgramState prg1 = new ProgramState(new MyStack<>(), new MyDict<>(), new MyList<>(), ex1,  new MyDict<>());
        ...
        ProgramState prg2 = new ProgramState(new MyStack<>(), new MyDict<>(), new MyList<>(), ex2, new MyDict<>());
                ...
                new CompoundStatement(new VariableDeclarationStatement("v", new IntType()),
                        new CompoundStatement(new AssignStatement("a", new ValueExpression(new BoolValue(true))),
                                new CompoundStatement(new IfStatement(new VariableExpression("a"),
                                        ...
                                        new PrintStatement(new VariableExpression("v"))))));
        ProgramState prg3 = new ProgramState(new MyStack<>(), new MyDict<>(), new MyList<>(), ex3,  new MyDict<>());
        ...
        ProgramState prg4 = new ProgramState(new MyStack<>(), new MyDict<>(), new MyList<>(), ex4, new MyDict<>());
        ...
        ProgramState prg5 = new ProgramState(new MyStack<>(), new MyDict<>(), new MyList<>(), ex5, new MyDict<>());
