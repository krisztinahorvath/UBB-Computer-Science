...
public class View {
    ...
    private void runPrg1() throws StmtExeException, ADTException, ExprEvalException, DivisionByZero {
    ...
    private void runPrg2() throws StmtExeException, ADTException, ExprEvalException, DivisionByZero {
    ...
    private void runPrg3() throws StmtExeException, ADTException, ExprEvalException, DivisionByZero {
    ...
    private void runStatement(IStatement stmt) throws ExprEvalException, StmtExeException, ADTException, DivisionByZero {
        MyIStack<IStatement> executionStack = new MyStack<>();
        MyIDict<String, IValue> symbolTable = new MyDict<>();
        MyIList<IValue> out = new MyList<>();

        ProgramState programState = new ProgramState(executionStack, symbolTable, out, stmt);

        IRepository repo = new Repository(programState);
