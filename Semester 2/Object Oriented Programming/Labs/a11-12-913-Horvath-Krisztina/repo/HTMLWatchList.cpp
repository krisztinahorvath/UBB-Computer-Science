...
void HTMLWatchList::write_to_file() {
    std::string file_name = R"(C:\Facultate\OOP\a11-12-913-Horvath-Krisztina\repo\HTMLWatchList.html)";
...
void HTMLWatchList::open_in_app() {
    std::string link = R"(C:\Facultate\OOP\a11-12-913-Horvath-Krisztina\repo\HTMLWatchList.html)";
